  ...
  <div class="flex flex-col gap-6 p-4">
    ...
    <template v-else>
      ...
      <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <div class="rounded-lg bg-muted p-4">
          <p class="mb-1 text-sm text-muted-foreground">Completados</p>
          <p class="text-2xl font-medium">
        ...
        <div class="rounded-lg bg-muted p-4">
          ...
          <p class="text-2xl font-medium">{{ metrics.overall_progress }}%</p>
          <p class="text-xs text-muted-foreground">promedio general</p>
        </div>
      </div>
